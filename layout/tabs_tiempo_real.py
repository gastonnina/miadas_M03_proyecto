...
def layout_tab_monitoreo_sismos():
    return dcc.Tab(label="🌐 Monitoreo Sísmico Global", children=[
        ...
        ], style={"padding": "10px 30px", "maxWidth": "800px"}),

        html.Div(id="contenedor-sismos-tiempo-real"),
        dcc.Interval(id="intervalo-sismos", interval=60000, n_intervals=0)  # actualiza cada 60 segundos
    ])
